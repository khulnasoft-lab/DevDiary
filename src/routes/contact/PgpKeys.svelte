  ...
  const keys = [
    {
      ...
      link: 'https://keybase.io/khulnasoft/pgp_keys.asc?fingerprint=0688f8d34587d954e9e51fb8fedb68f55c0283a7',
    },
    {
      label: 'Email',
    ...
    {
      label: 'Matrix',
      value: '@khulnasoft-lab:matrix.org',
      link: 'https://matrix.to/#/@khulnasoft-lab:matrix.org',
    },
    {
      label: 'XMPP',
