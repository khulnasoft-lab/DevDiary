...
const config: SiteConfig = {
  title: 'Dev Diary',
  description: '',
  source: 'https://github.com/khulnasoft-lab/devdiary',
  baseUrl: 'https://as93.net',
  initialFeeds: [{ label: 'Notes', url: 'https://raw.githubusercontent.com/khulnasoft-lab/feeds/main/blog.atom' }],
  additionalFeeds: [
    { label: 'Notes', url: 'https://notes.khulnasoft.com/feed' },
    {
      label: 'Dev.to',
      url: 'https://raw.githubusercontent.com/khulnasoft-lab/feeds/main/dev-to.atom',
    },
    {
      label: 'BlogSpot',
      url: 'https://raw.githubusercontent.com/khulnasoft-lab/feeds/main/blogger.atom',
    },
    {
      label: 'GitHub',
      url: 'https://raw.githubusercontent.com/khulnasoft-lab/feeds/main/github.atom',
    },
    {
      label: 'StackOverflow',
      url: 'https://raw.githubusercontent.com/khulnasoft-lab/feeds/main/stackoverflow.atom',
    },
    // { label: 'Twitter', url: 'https://raw.githubusercontent.com/khulnasoft-lab/feeds/main/twitter.atom' },
    {
      label: 'Reddit',
      url: 'https://raw.githubusercontent.com/khulnasoft-lab/feeds/main/reddit.atom',
    },
    {
      label: 'Mastodon',
      url: 'https://raw.githubusercontent.com/khulnasoft-lab/feeds/main/mastodon.atom',
    },
    {
      label: 'YouTube',
      url: 'https://raw.githubusercontent.com/khulnasoft-lab/feeds/main/youtube.atom',
    },
  ],
  ...
  workExperience: [
    ...
    {
      company: 'Freelance',
      companyUrl: 'https://khulnasoft.com/',
  ...
  projectComplimentaryData: [
    ...
    {
      name: 'brewfile',
      thumbnail: 'https://i.ibb.co/N9c30xT/khulnasoft-lab-brewfile-banner.png',
    },
    {
      name: 'bug-bounties',
    ...
    {
      name: 'devdiary',
      thumbnail: 'https://i.ibb.co/ZhMTxmR/devdiary-banner-image.png',
    },
    {
  ...
  contact: {
    ...
    socials: {
      Twitter: 'Lissy_Sykes',
      GitHub: 'khulnasoft-lab',
      'Dev.to': 'khulnasoft-lab',
      Mastodon: '@khulnasoft-lab',
      LinkedIn: 'in/KhulnaSoft',
    ...
    pgpKeyLink: 'https://keybase.io/khulnasoft/pgp_keys.asc?fingerprint=0688f8d34587d954e9e51fb8fedb68f55c0283a7',
...
`,
  ...
  about: {
    ...
    bio: [
      ...
      `I enjoy going to (<a href="https://notes.khulnasoft.com/p/0s5s3uOtKj">and sometimes winning!</a>) hackathons.
